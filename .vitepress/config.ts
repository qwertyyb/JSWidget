      ...
      '/api/': [
        {
          ...
          items: [
            ...
            { text: '位置服务', link: '/api/#_6-位置服务-api' },
            { text: '本地存储', link: '/api/#_7-本地存储-api' },
            { text: '环境变量', link: '/api/#_8-环境变量-api' },
            { text: '文件导入', link: '/api/#_9-文件导入-api' },
            { text: '渲染', link: '/api/#_10-渲染-api' },
            { text: '灵动岛', link: '/api/#_11-灵动岛-api' },
            { text: '组件定义', link: '/api/#_12-组件定义-api' },
          ],
        },
      ],
    },

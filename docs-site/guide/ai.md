...
4. AI 会依据提示词里的**官方文档链接**生成可在本应用中使用的 **`main.jsx`**；将生成结果粘贴回 ScriptWidget 即可。
...
```
你正在协助用户编写 ScriptWidget（iOS / macOS 桌面小组件）脚本。

在写出任何 API 或 JSX 标签之前，请先根据下列官方文档（Markdown 源）作答；不要臆造文档中不存在的 API 或组件名：

1. 快速入门：https://raw.githubusercontent.com/qwertyyb/ScriptWidget/main/docs/getting-started.md
2. 运行时 API：https://raw.githubusercontent.com/qwertyyb/ScriptWidget/main/docs/api.md
3. 组件与属性：https://raw.githubusercontent.com/qwertyyb/ScriptWidget/main/docs/components.md

可选补充（面向模型的编写约定）：https://raw.githubusercontent.com/qwertyyb/ScriptWidget/main/docs/ai-for-llms.md

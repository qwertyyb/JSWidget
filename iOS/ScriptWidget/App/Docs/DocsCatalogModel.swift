...
enum DocsCatalog {
    static let sections: [DocSection] = [
        ...
        DocSection(title: "Components", items: [
            ...
            DocItem(title: "Text", icon: "textformat", file: "components.md", anchor: "文本"),
            DocItem(title: "Image & Media", icon: "photo", file: "components.md", anchor: "图片与媒体"),
            DocItem(title: "Interactive", icon: "hand.tap", file: "components.md", anchor: "交互"),
            DocItem(title: "Charts", icon: "chart.bar", file: "components.md", anchor: "图表"),
            DocItem(title: "Shapes", icon: "circle", file: "components.md", anchor: "形状与装饰"),
            DocItem(title: "Icons & Labels", icon: "puzzlepiece", file: "components.md", anchor: "图标与标签"),
            DocItem(title: "Progress & Stats", icon: "chart.bar.fill", file: "components.md", anchor: "进度与数据展示"),
            DocItem(title: "Gauge", icon: "dial.medium.fill", file: "components.md", anchor: "仪表"),
            DocItem(title: "Spacer", icon: "arrow.up.and.down", file: "components.md", anchor: "布局辅助"),
        ...
        DocSection(title: "APIs", items: [
            ...
            DocItem(title: "Location", icon: "location", file: "api.md", anchor: "6-位置服务-api"),
            DocItem(title: "Storage", icon: "externaldrive", file: "api.md", anchor: "7-本地存储-api"),
            DocItem(title: "Environment", icon: "gear", file: "api.md", anchor: "8-环境变量-api"),
            DocItem(title: "Import", icon: "arrow.down.circle", file: "api.md", anchor: "9-文件导入-api"),
            DocItem(title: "Render", icon: "paintbrush", file: "api.md", anchor: "10-渲染-api"),
            DocItem(title: "Dynamic Island", icon: "circle.dotted", file: "api.md", anchor: "11-灵动岛-api"),
        ]),
    ]
}
